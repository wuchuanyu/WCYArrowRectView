...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let arrowRectView7 = WCYArrowRectView(frame: CGRectMake(140, 400, 80, 100))
        ...
        arrowRectView7.strokeWidth = 6
        arrowRectView7.strokeColor = UIColor.redColor()
        arrowRectView7.fillColor = UIColor(red: 219/255.0, green: 249/255.0, blue: 149/255.0, alpha: 1.0)
